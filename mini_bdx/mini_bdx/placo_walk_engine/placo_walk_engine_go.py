...
class PlacoWalkEngineGo:
    def __init__(
        self,
        model_filename: str = "../../robots/go_bdx/go_bdx.urdf",
        ...
        # Posture parameters
        self.parameters.walk_com_height = 0.3  # Constant height for the CoM [m]
        ...
        self.parameters.feet_spacing = 0.3  # Lateral feet spacing [m] # 12
